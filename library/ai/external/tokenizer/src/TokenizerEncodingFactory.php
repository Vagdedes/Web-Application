...
class TokenizerEncodingFactory
{
    ...
    public static function createByModelName(string $modelName): TokenizerEncoding
    {
        $encodingName = null;
    ...
    public static function createByEncodingName(string $encodingName): TokenizerEncoding
    {
    ...
    protected static function initConstructor()
    {
        ...
        static::$encodingConstructors = [
            'gpt2' => function () {
                ...
                return new TokenizerEncoding('gpt2', $mergeableRanks, $pattenRegex, $specialTokens, explicitNVocab: 50257);
            },
            'r50k_base' => function () {
                ...
                return new TokenizerEncoding('r50k_base', $mergeableRanks, $pattenRegex, $specialTokens, explicitNVocab: 50257);
            },
            'p50k_base' => function () {
                ...
                return new TokenizerEncoding('p50k_base', $mergeableRanks, $pattenRegex, $specialTokens, explicitNVocab: 50281);
            },
            'p50k_edit' => function () {
                $mergeableRanks = static::loadTiktokenBpe(__DIR__ . '/assets/p50k_base.tiktoken');
                $pattenRegex = "/'s|'t|'re|'ve|'m|'ll|'d| ?\p{L}+| ?\p{N}+| ?[^\s\p{L}\p{N}]+|\s+(?!\S)|\s+/";
                ...
                return new TokenizerEncoding('p50k_edit', $mergeableRanks, $pattenRegex, $specialTokens);
            },
            'cl100k_base' => function () {
                ...
                return new TokenizerEncoding('cl100k_base', $mergeableRanks, $pattenRegex, $specialTokens);
            },
            'o200k_base' => function () {
                ...
                return new TokenizerEncoding('o200k_base', $mergeableRanks, $pattenRegex, $specialTokens);
            },
        ];
    }
