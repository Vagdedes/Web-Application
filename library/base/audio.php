...
function convert_base64_mp4_to_base64_wav(string $base64): ?string
{
    // 1.
    $oldData = @base64_decode($base64);
    ...
    // 2.
    $oldFile = tempnam(sys_get_temp_dir(), 'mp4');
    @file_put_contents($oldFile, $oldData);
    // 3.
    $newFile = tempnam(sys_get_temp_dir(), 'wav');
    // 4.
...
function convert_base64_mp4_to_base64_mp3(string $base64): ?string
{
    // 1.
    $oldData = @base64_decode($base64);
